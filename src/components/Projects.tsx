...
export default function Projects() {
  const projects = [
    ...
    {
      name: 'mc-banHwid',
      description: 'Minecraft Java Edition HWID ban system for server administration.',
      language: 'Java',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/mc-banHwid',
      featured: true,
    },
    {
      name: 'e-GP_Module',
    ...
    {
      name: 'Auto_e-GP',
      description: 'Python automation tool for Thai e-Government Procurement workflows.',
      language: 'Python',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/Auto_e-GP',
      featured: false,
    },
    {
      name: 'JSe-GP_module',
      description: 'JavaScript implementation of the e-Government Procurement module.',
      language: 'JavaScript',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/JSe-GP_module',
      featured: false,
    },
    {
      name: 'equipment',
      description: 'Equipment management system built with JavaScript.',
      language: 'JavaScript',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/equipment',
      featured: false,
    },
    {
      name: 'nestjs-tutorial-backend',
      description: 'Backend tutorial project built with NestJS and TypeScript.',
      language: 'TypeScript',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/nestjs-tutorial-backend',
      featured: false,
    },
    {
      name: 'BKlCore',
      description: 'Core Java library for game server development.',
      language: 'Java',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/BKlCore',
      featured: false,
    },
    {
      name: 'RealisticSurvivalAddOn',
      description: 'Minecraft Java plugin for realistic survival gameplay mechanics.',
      language: 'Java',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/RealisticSurvivalAddOn',
      featured: false,
    },
    {
      name: 'PBIPEditor',
      description: 'PBIP file editor tool built with C#.',
      language: 'C#',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/PBIPEditor',
      featured: false,
    },
    {
      name: 'demo-yii',
      description: 'Demo project built with Yii PHP framework.',
      language: 'PHP',
      stars: 0,
      forks: 0,
      url: 'https://github.com/h4rdl0ckl3z/demo-yii',
      featured: false,
    }
  ];
