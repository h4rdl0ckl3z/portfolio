        ...
        <section id="about" className="py-20">
            <div className="container mx-auto text-center">
                ...
                <p className="text-xl mb-8">
                    I am very interested in applying for this position or any related positions within the company. I would like to utilize my knowledge and skills in contributing to the organization. I am highly motivated to join, learn and grow together with the company.
                </p>
