...
export const SectionWork = () => {
    ...
    const events = [
        { year: 'Full Stack Developer | 11/12/2024 - 5/3/2025', title: 'Elegance Consultant Co.,Ltd.', description: 'Full Stack Developer with Devops', details: ['Learning Tech (Devops, ASP.NET Core, NextJS, CI/CD)', 'SingleSignOn (KeyCloak Provider)', 'SSO Client Realm Management (NextJS)'] },
