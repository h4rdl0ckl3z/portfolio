...
export const SectionWork = () => {
    ...
    const events = [
        { year: 'Full Stack Developer | 11/12/2024 - 5/3/2025', title: 'Elegance Consultant Co.,Ltd.', description: 'Full Stack Developer with Devops, Provide Trial', details: ['Learning Tech', 'SingleSignOn'] },
